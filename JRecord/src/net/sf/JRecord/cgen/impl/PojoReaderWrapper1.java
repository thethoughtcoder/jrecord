...
public class PojoReaderWrapper1<Line> implements IReader<Line> {
	...
	public static <Line> PojoReaderWrapper1<Line> newReader(AbstractByteReader reader, IAsPojoSetData<Line> converter) {
	...
	private PojoReaderWrapper1(AbstractByteReader reader, IAsPojoSetData<Line> converter) {
		super();
		this.reader = reader;
